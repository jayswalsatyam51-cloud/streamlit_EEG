    ...
    *,
    ...
    if not stats.empty:
        ...
        if not sec_stats.empty:
            charts["band_radar"] = figure_to_json(
                fig_band_radar(
                    stats,
                    section=section,
            ...
            charts["subsection_radar"] = figure_to_json(
                fig_subsection_radar(
                    stats,
                    section=section,
                    band=band,
...
def build_neurotrack_charts(
    ...
    *,
    ...
    if not pkg.horizontal_matrix.empty:
        charts["matrix_radar"] = figure_to_json(
            fig_matrix_radar(pkg.horizontal_matrix, ec_label=ec_label, eo_label=eo_label)
        )
